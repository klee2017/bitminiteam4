    ...
    <form id="write" name="write" action="/makeFriendsTravel/html/qnaWrite.do" method="get">
	    <div class="post-section">
	      ...
	      <div class="post-title">
			<textarea class="Title" name="title" class="post-input" placeholder="제목을 입력하세요" rows="1" cols="140">${user.title}</textarea>
	      </div>
	      <br>
	      <div class="post-content">
	        <textarea class="Content" name="content" class="post-input" placeholder="내용을 입력하세요" rows="30" cols="140">${user.content}</textarea>
	      </div>
	    </div>
    </form>
